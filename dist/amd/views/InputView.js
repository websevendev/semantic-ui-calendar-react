    ...
    var InputView = /** @class */ (function (_super) {
        ...
        function InputView() {
            ...
            _this.scrollListener = function () {
                var _a = _this.props, closeOnScroll = _a.closeOnScroll, closePopup = _a.closePopup;
                if (closeOnScroll) {
                    closePopup();
                }
            };
                ...
                !readOnly
                    &&
                        React.createElement(semantic_ui_react_1.Transition, { unmountOnHide: true, mountOnShow: true, visible: !popupIsClosed, animation: animation, duration: duration, onComplete: function () {
                            ...
                            React.createElement(semantic_ui_react_1.Popup, __assign({ position: popupPosition, open: true, hoverable: closeOnMouseLeave, flowing: true, style: popupStyle, context: this.inputNode, on: 'hover', mountNode: mountNode }, popupProps),
